      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            CircleAvatar(
              radius: 24,
              backgroundImage: widget.review.user.profilePicture.isNotEmpty
                  ? NetworkImage(widget.review.user.profilePicture)
                  : null, // Jika ada gambar, tampilkan
              child: widget.review.user.profilePicture.isEmpty
                  ? const Icon(Icons.person, color: Colors.white, size: 24)
                  : null, // Jika tidak ada, tampilkan ikon
              backgroundColor: widget.review.user.profilePicture.isEmpty ? Colors.grey : null,
            ),
